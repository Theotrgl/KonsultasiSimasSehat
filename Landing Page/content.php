...
<body>
    ...
    <div class="banner">
        <img src="./assets/IMG-2.jpg" alt="banner">
    </div>
    ...
    <div class="carousel" data-flickity='{ "autoPlay": true }'>
      ...
      <div class="carousel-cell">
        <img src="https://images.unsplash.com/photo-1494976388531-d1058494cdd8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Y2Fyc3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="img-1">
        <div class="text">
          <h2>Title 6</h2>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur eleifend sed orci vitae hendrerit. Maecenas maximus elit quis ultrices varius. Quisque iaculis et felis id vehicula.</p>
          <button onclick="window.location.href='content.php'" class="card-button">Learn More</button>
